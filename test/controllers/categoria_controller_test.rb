...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { atualizado_por: @categorium.atualizado_por, criado_por: @categorium.criado_por, descricao: @categorium.descricao } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { atualizado_por: @categorium.atualizado_por, criado_por: @categorium.criado_por, descricao: @categorium.descricao } }
