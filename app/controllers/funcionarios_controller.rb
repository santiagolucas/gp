class FuncionariosController < ApplicationController
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :data_aniversario, :criado_por, :atualizado_por, :sexo, :endereco, :email, :bairro, :municipio_id, :data_admissao, :data_desligamento, :cep, :telefone, :celular, :cpf, :matricula)
    end
end
